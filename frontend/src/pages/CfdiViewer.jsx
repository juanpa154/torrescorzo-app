...
export default function CfdiViewer({
  ...
  useEffect(() => {
    fetchCfdis();
  }, [schema, mes, anio, page, cfdiTipo, rfc, minMonto, maxMonto]);
  ...
  return (
    <div className="cfdi-container p-4">
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        ...
        <input
          type="text"
          placeholder={`RFC ${tipoRfcFiltro === 'rfc_receptor' ? 'Receptor' : 'Emisor'}`}
          value={rfc}
        ...
        <select
          value={cfdiTipo}
          onChange={(e) => { setCfdiTipo(e.target.value); setPage(1); }}
